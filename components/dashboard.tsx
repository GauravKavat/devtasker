...
const Calendar = dynamic(
  () => import("@/app/(main)/(routes)/_components/calender"),
  { ssr: false },
);
const Github = dynamic(
  () => import("@/app/(main)/(routes)/_components/github"),
  { ssr: false },
);
const GithubRepos = dynamic(
  () => import("@/app/(main)/(routes)/_components/github-repos"),
  { ssr: false },
);
const GithubUrl = dynamic(
  () => import("@/app/(main)/(routes)/_components/github-url"),
  { ssr: false },
);
const Teams = dynamic(() => import("@/app/(main)/(routes)/_components/team"), {
  ssr: false,
});
...
export function Dashboard({ projectId, projectName }: DashboardProps) {
  ...
  const getPageContent = () => {
    switch (view) {
      ...
      case "github-repos":
        return projectId ? <GithubRepos projectId={projectId} /> : null;
      case "github-url":
        return <GithubUrl projectId={projectId} />;
      case "team":
