  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <footer className="border-t bg-background">
        <div className="px-6 py-12 mx-auto w-full">
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                ...
                <li>
                  <a href="#" className="text-sm text-muted-foreground hover:text-primary">Changelog</a>
                </li>
              </ul>
            </div>
          ...
          <div className="flex flex-col items-center gap-6 pt-8 mt-8 border-t">
            <p className="text-sm text-center text-muted-foreground">
              © {new Date().getFullYear()} DevTasker. All rights reserved.
            </p>
